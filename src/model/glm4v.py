...
ori_glm.transformer = glm_model.transformer
...
glm4v = {"vae_model": glm_model, "ori_model": ori_glm, "tokenizer": tokenizer, "FEATURE_MAP": get_feature_map}
__all__ = [glm4v]